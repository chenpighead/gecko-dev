                                   ...
                                   bool aLangIsCJ)
{
  ...
  if (ch == ' ' || ch == CH_NBSP) {
    if (aTextStyle->mTextJustify == StyleTextJustify::Auto ||
  ...
  if (aTextStyle->mTextJustify == StyleTextJustify::InterCharacter ||
      aTextStyle->mTextJustify == StyleTextJustify::Distribute) {
      return true;
  }
